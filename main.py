...
BOT_NAME = os.environ.get("BOT_NAME", "˹𝐉ᴀʀᴠɪ𝐬 ✘ Mᴜsɪᴄ ˼")
BOT_LINK = os.environ.get("BOT_LINK", "https://t.me/Starktestingbot")
...
async def fallback_local_playback(chat_id: int, message: Message, song_info: dict):
    ...
    try:
        ...
        base_caption = (
            "<blockquote>"
            "<b>🎧 ˹𝐉ᴀʀᴠɪ𝐬 ✘ Mᴜsɪᴄ ˼ Streaming</b> (Local Playback)\n\n"
...
async def frozen_check_command(client: Client, message):
    await message.reply_text("JARVIS check successful ✨")
...
if __name__ == "__main__":
    ...
    me = bot.get_me()
    BOT_NAME = me.first_name or "˹𝐉ᴀʀᴠɪ𝐬 ✘ Mᴜsɪᴄ ˼"
    BOT_USERNAME = me.username or os.getenv("BOT_USERNAME", "https://t.me/starktestingbot")
